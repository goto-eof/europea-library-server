...
- During my tests (in debug mode) I noticed that the job, in order to index and extract metadata from 8.850 files in a
  ...
  same notebook I ran
  the multi-thread job and the result is the following: about ~3.5 minutes to index 8.850 files. I also run the
  ...
  equipped with SSD, and it took 40 minutes to finish
